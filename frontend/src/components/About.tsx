        ...
        <footer id="about" className="min-h-screen w-full bg-zinc-900 px-6 sm:px-8 flex flex-col items-center justify-center text-center mt-auto py-8 sm:py-12">
            <div className="max-w-4xl w-full flex flex-col gap-6 sm:gap-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto w-full">
                    ...
                    { }
                    <motion.a
                        href="https://github.com/VitorRovaniMarcelino"
                        target="_blank"
                        rel="noopener noreferrer"
                        whileHover={{ y: -8, backgroundColor: "rgba(255,255,255,0.08)" }}
                        transition={{ type: "spring", stiffness: 400, damping: 20 }}
                        className="bg-white/5 p-5 sm:p-8 rounded-[2rem] border border-white/5 text-left flex flex-col gap-4 group cursor-pointer shadow-xl decoration-transparent"
                    >
                        <motion.div
                    ...
                    { }
                    <motion.a
                        href="https://github.com/PedroGoulartbranco"
                        target="_blank"
                        rel="noopener noreferrer"
                        whileHover={{ y: -8, backgroundColor: "rgba(255,255,255,0.08)" }}
                        transition={{ type: "spring", stiffness: 400, damping: 20 }}
                ...
                <div className="pt-4 flex flex-col items-center gap-4">
                    <div className="flex gap-6">
                        <motion.a
                            href="https://github.com/PedroGoulartbranco/AuraDownload-videos"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    <p className="text-zinc-700 text-[9px] sm:text-[10px] font-black uppercase tracking-[0.6em]">
                        Flux Media © 2026
                    </p>
                </div>
            </div>
